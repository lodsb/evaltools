...
p1 <- ggplot(data3, aes(time/(1000*60))) + geom_line(aes(y=10*meanWnbd, color= c("meanWnbd"))) + geom_line(aes(y=meanOdd, colour="meanOdd")) + geom_line(aes(y=length/1, colour="length")) + scale_x_continuous(name="time in minutes",limits=c(0, 20)) +  scale_y_continuous(limits=c(0, 100)) 
